...
{
    std::unique_ptr<frc::SpeedController> leftMotor(new frc::Talon(PwmPins::CLAW_LEFT));
    std::unique_ptr<frc::SpeedController> rightMotor(new frc::Talon(PwmPins::CLAW_RIGHT));
...
{
    std::unique_ptr<frc::SpeedController> frontLeftMotor(new frc::VictorSP(PwmPins::DRIVETRAIN_FRONT_LEFT));
    std::unique_ptr<frc::SpeedController> frontRightMotor(new frc::VictorSP(PwmPins::DRIVETRAIN_FRONT_RIGHT));
    std::unique_ptr<frc::SpeedController> rearLeftMotor(new frc::VictorSP(PwmPins::DRIVETRAIN_REAR_LEFT));
    std::unique_ptr<frc::SpeedController> rearRightMotor(new frc::VictorSP(PwmPins::DRIVETRAIN_REAR_RIGHT));
...
{
    std::unique_ptr<frc::SpeedController> winchMotor(new frc::Spark(PwmPins::WINCH));
